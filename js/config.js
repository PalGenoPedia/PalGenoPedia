...
(function() {
    ...
    window.translationConfig = {
        ...
        customTranslationPath: function(lang) {
            ...
            // Cache-bust like translation-system.js's own default path does -
            // without this, this override (which every page using config.js
            // takes instead of that default) serves whatever a returning
            // visitor's browser already cached for translations/<lang>.json,
            // silently hiding any edit to the translation files.
            const translationPath = `${rootPath}translations/${lang}.json?v=${Date.now()}`;
